...
public final class RunAllTests {
    ...
    public static void main(String[] args) {
        TestRunner.run(BallotTest.class, LogTest.class, AcceptorTest.class, ProposerTest.class, LearnerTest.class,
                SimulatedNetworkTest.class, NodeTest.class, SingleDecreePaxosTest.class, MultiSlotPaxosTest.class);
    }
}
